...
import SubTable from './KundenSubTable';
import data from './data.json';
import Navbar from '../../Nav/Navbar';

const KundenFilterableTable = () => {
  ...
  return (
    <div>
      <Navbar/>
      <h2 className='breadcrumb'> HighLevel Bereiche \ Kunden</h2>
                ...
                <TableRow>
                  <TableCell colSpan={5}>
                    <Collapse in={expandedRow === item.id} timeout="auto" unmountOnExit>
                      <Accordion>
                        <SubTable
                          subTableDataKunden ={item.subTableDataKunden}
                        />
                      </Accordion>
                    </Collapse>
                  </TableCell>
...
export default KundenFilterableTable;
