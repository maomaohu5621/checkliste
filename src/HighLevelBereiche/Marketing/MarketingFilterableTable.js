...
import SubTable from './MarketingSubTable';
import data from './data.json';
import Navbar from '../../Nav/Navbar';

const MarketingFilterableTable = () => {
  ...
  return (
    <div>
      <Navbar/>
      <h2 className='breadcrumb'> HighLevel Bereiche \ Marketing</h2>
                ...
                <TableRow>
                  <TableCell colSpan={5}>
                    <Collapse in={expandedRow === item.id} timeout="auto" unmountOnExit>
                      <Accordion>
                        <SubTable
                          subTableDataMarketing={item.subTableDataMarketing}
                        />
                      </Accordion>
                    </Collapse>
                  </TableCell>
...
export default MarketingFilterableTable;
