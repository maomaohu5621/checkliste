...
import SubTable from './SupportSubTable';
import data from './data.json';
import Navbar from '../../Nav/Navbar';

const SupportFilterableTable = () => {
  ...
  return (
    <div>
      <Navbar/>
      <h2 className='breadcrumb'> HighLevel Bereiche \ Support</h2>
                ...
                <TableRow>
                  <TableCell colSpan={5}>
                    <Collapse in={expandedRow === item.id} timeout="auto" unmountOnExit>
                      <Accordion>
                        <SubTable
                          subTableDataSupport={item.subTableDataSupport}
                        />
                      </Accordion>
                    </Collapse>
                  </TableCell>
...
export default SupportFilterableTable;
