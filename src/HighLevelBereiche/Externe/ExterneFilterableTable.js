...
import SubTable from './ExterneSubTable';
import data from './data.json';
import Navbar from '../../Nav/Navbar';

const ExterneFilterableTable = () => {
  ...
  return (
    <div>
      <Navbar/>
      <h2 className='breadcrumb'> HighLevel Bereiche \ Externe</h2>
                ...
                <TableRow>
                  <TableCell colSpan={5}>
                    <Collapse in={expandedRow === item.id} timeout="auto" unmountOnExit>
                      <Accordion>
                        <SubTable
                          subTableDataExterne={item.subTableDataExterne}
                        />
                      </Accordion>
                    </Collapse>
                  </TableCell>
...
export default ExterneFilterableTable;
