...
import SubTable from './VertriebSubTable';
import data from './data.json';
import Navbar from '../../Nav/Navbar';

const VertriebFilterableTable = () => {
  ...
  return (
    <div>
      <Navbar/>
      <h2 className='breadcrumb'> HighLevel Bereiche \ Vertrieb</h2>
                ...
                <TableRow>
                  <TableCell colSpan={5}>
                    <Collapse in={expandedRow === item.id} timeout="auto" unmountOnExit>
                      <Accordion>
                        <SubTable
                          subTableDataVertrieb={item.subTableDataVertrieb}
                        />
                      </Accordion>
                    </Collapse>
                  </TableCell>
...
export default VertriebFilterableTable;
