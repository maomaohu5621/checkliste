...
import SubTable from './EinkaufSubTable';
import data from './data.json';
import Navbar from '../../Nav/Navbar';

const EinkaufFilterableTable = () => {
  ...
  return (
    <div>
      <Navbar/>
      <h2 className='breadcrumb'> HighLevel Bereiche \ Einkauf</h2>
                ...
                <TableRow>
                  <TableCell colSpan={5}>
                    <Collapse in={expandedRow === item.id} timeout="auto" unmountOnExit>
                      <Accordion>
                        <SubTable
                          subTableDataEinkauf={item.subTableDataEinkauf}
                        />
                      </Accordion>
                    </Collapse>
                  </TableCell>
...
export default EinkaufFilterableTable;
